 ...
 * @method self reload($value) 设置以后内容每次都会重新渲染，对于 crud 的重新拉取很有用
 * @method self unmountOnExit($value) 每次退出都会销毁当前 tab 栏内容
 * @method self className($value) Tab 区域样式
 * @method self closable($value) 是否支持删除，优先级高于组件的 closable
